...
The Wizard will guide you through four distinct 60-second phases. Here is your cheat sheet for acing them:

### Phase 1: 🧘 REST (Baseline)
*   **Goal**: Find your absolute calm.
*   **Action**: Sit comfortably. hands on knees. Close your eyes. Breathe slowly and deeply (4 seconds in, 6 seconds out).
...
*   **Action**: **GO!** Do Jumping Jacks, High Knees, or Burpees. Go hard. We need to drive your Heart Rate up.
*   **Why**: This measures your "Throttle Response". How fast can your heart mobilize energy?

### Phase 4: ❄️ RECOVERY (The Cooldown)
...
Once complete, the system calculates your unique **Bio-Profile**:

| Metric | What it means |
| :--- | :--- |
| **Baseline HRV** | Your fuel tank. Use this to determine if you should push hard or take it easy. |
| **Max HR** | Your redline. We update your age-predicted max if you exceed it. |
| **Recovery Score** | Your cooling system efficiency. |

> **Pro Tip:** Do not drink caffeine immediately before calibration, or your "Rest" scores will be skewed!

Ready? Go to the Dashboard and click **"Run Calibration"**.
