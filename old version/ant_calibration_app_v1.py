...
class CalibrationApp(tk.Tk):
    ...
    def play_beep(self):
        ...
        if system_os == "Windows":
            ...
            # Method 1: Tkinter Bell (Often muted by OS)
            self.bell()
            # Method 2: ASCII Bell to stdout (Works in most terminals)
            print('\a')
    ...
    def show_instruction(self, phase):
        ...
        ttk.Label(frame, text=texts[phase], justify="center", font=("Arial", 14)).pack(pady=20)
    ...
    def save_profile(self):
        ...
        profile.max_hr = max(180, self.results['exertion']['max_hr'])
        ...
        if os.path.exists(full_path):
            ...
            try:
                ...
                elif "resting_hr" in old_data:
                    final_data["history"].append({
                        "date": "Legacy",
                        "resting_hr": old_data.get("resting_hr"),
                        "baseline_rmssd": old_data.get("baseline_rmssd")
                    })
            except Exception as e:
